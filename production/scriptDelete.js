...
document.getElementById("saveButton").addEventListener("click", function () {
  ...
  if (desc != "" && url != "" && title != "") {
    fetch(
      "https://vues-e705c-default-rtdb.firebaseio.com/" + caseName + ".json",
      {
        method: "POST",
        headers: {
...
function deleteObjectById(uniqueId, ojects) {
  // Construct the URL to the specific object using its unique ID
  const url = `https://vues-e705c-default-rtdb.firebaseio.com/${ojects}/${uniqueId}.json`;
  fetch(url, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
    ...
    .then((response) => {
      if (response.ok) {
        ...
        console.log(`Object with ID ${uniqueId} deleted successfully`);
      } else {
        console.error(
          `Error deleting object with ID ${uniqueId}:`,
          response.statusText
        );
      }
    })
...
function start() {
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/data_down.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        // Create a "Danger" button for each item with an onclick event
        const dropdownMenu = document.getElementById("data_down");
        const deleteButton = document.createElement("button");
        deleteButton.innerHTML = data[id].title;
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "data_down"); // Call the deleteObjectById function with the current id
        };
  ...
  // data_and_voice_down
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/data_and_voice_down.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "data_and_voice_down"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/physical_instability.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "physical_instability"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/blq.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "blq"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
      console.log(blq);
  ...
  // wrong_card_and_port
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/wrong_card_and_port.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "wrong_card_and_port"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  // logical_instability
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/logical_instability.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "logical_instability"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  // unable_to_obtain
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/unable_to_obtain.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/slowness.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "slowness"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/outage.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "outage"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
      console.log(outage);
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/wirless.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "wirless"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
      console.log(wirless);
  ...
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/data_and_voice_down_ftth.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "data_and_voice_down_ftth"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/browsing_ftth.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "browsing_ftth"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/wrong_card_and_port_ftth.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "wrong_card_and_port_ftth"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch(
    "https://vues-e705c-default-rtdb.firebaseio.com/unable_to_obtain_ftth.json",
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "unable_to_obtain_ftth"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/slowness_ftth.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "slowness_ftth"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/idel.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "idel"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
      console.log(idel);
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/concession.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "concession"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/complain.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "complain"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/Cancellation.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "Cancellation"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/quota.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "quota"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
      console.log(quota);
  ...
  fetch("https://vues-e705c-default-rtdb.firebaseio.com/other.json", {
    ...
    .then((data) => {
      ...
      for (const id in data) {
        ...
        deleteButton.classList.add("btn", "btn-danger");
        deleteButton.onclick = function () {
          deleteObjectById(id, "other"); // Call the deleteObjectById function with the current id
        };
        dropdownMenu.appendChild(deleteButton);
      }
      console.log(other);
